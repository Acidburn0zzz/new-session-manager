...
You can use the [editor on GitHub](https://github.com/Acidburn0zzz/new-session-manager/edit/gh-pages/index.md) 
...
[repository settings](https://github.com/Acidburn0zzz/new-session-manager/settings/pages). 
